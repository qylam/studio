...
export const dictionaries = {
  ...
  ko: {
    // --- Home Page ---
    home_title_main: "[KOREAN] The free-time machine",
    home_title_sub: "[KOREAN] Chrome Connect",
    home_description: "[KOREAN] Picture yourself with up to 10 hours back per week, thanks to Gemini.",
    home_start_button: "[KOREAN] Start",
    home_link_details: "[KOREAN] See how Gemini is helping you save up to 10 hours per week",
    home_consent_title: "[KOREAN] Before you begin",
    home_consent_desc: "[KOREAN] The Gemini Free-Time Machine is an experiment using Nano Banana 2, Google's latest generative model.\n\nTake a photo and we'll create a picture using your selected effect. By submitting your photo, you confirm that you are 18 or older and consent to Google processing your image to generate your picture. To download it, simply scan the QR code provided at the end.",
    home_consent_accept: "[KOREAN] Accept and proceed",
    home_consent_decline: "[KOREAN] Do not accept",
    home_consent_loading: "[KOREAN] Connecting...",

    // --- Kiosk Flow: Camera ---
    camera_title: "[KOREAN] Strike a Pose!",
    camera_subtitle: "[KOREAN] Look directly into the camera. A clean, well-lit face works best.",
    camera_btn_take: "[KOREAN] Take Photo",
    camera_btn_retake: "[KOREAN] Retake Photo",
    camera_btn_continue: "[KOREAN] Looks Good",
    ...
    btn_back: "[KOREAN] Back",
    btn_surprise: "[KOREAN] Surprise me!",
    btn_generate: "[KOREAN] Make these updates",


    // --- Kiosk Flow: Dynamic UI ---
    camera_smile: "[KOREAN] Smile!",
    camera_wheelchair: "[KOREAN] I'm a wheelchair user",
    ...
    style_keychain_title: "[KOREAN] 3D Keychain",
    ...
    style_oil_title: "[KOREAN] Oil Painting",
    ...
    style_clay_title: "[KOREAN] Claymation",
    ...
    style_editorial_title: "[KOREAN] Magazine Editorial",
    ...
    style_cinematic_title: "[KOREAN] Cinematic Epic",
    ...
    style_noir_title: "[KOREAN] Timeless Noir",
    ...
    style_visionary_title: "[KOREAN] Tech Visionary",
    ...
    // --- THEMES ---
    theme_recipe_title: "[KOREAN] Learn a new recipe",
    theme_recipe_var0_scene: "[KOREAN] rustic Italian villa kitchen",
    theme_recipe_var0_activity: "[KOREAN] kneading fresh pasta dough",
    theme_recipe_var1_scene: "[KOREAN] molecular gastronomy lab",
    theme_recipe_var1_activity: "[KOREAN] creating edible liquid nitrogen art",
    theme_recipe_var2_scene: "[KOREAN] bustling street food market",
    theme_recipe_var2_activity: "[KOREAN] tossing a perfect artisan pizza",

    theme_zen_title: "[KOREAN] Find my zen",
    theme_zen_var0_scene: "[KOREAN] misty mountaintop temple",
    theme_zen_var0_activity: "[KOREAN] performing slow, graceful Tai Chi",
    theme_zen_var1_scene: "[KOREAN] floating crystal lotus pod",
    theme_zen_var1_activity: "[KOREAN] deep meditation in zero gravity",
    theme_zen_var2_scene: "[KOREAN] glowing bioluminescent forest",
    theme_zen_var2_activity: "[KOREAN] listening to the whispers of ancient trees",

    theme_active_title: "[KOREAN] Get more active",
    theme_active_var0_scene: "[KOREAN] neon-lit urban rooftop",
    theme_active_var0_activity: "[KOREAN] mastering high-speed parkour",
    theme_active_var1_scene: "[KOREAN] underwater coral gymnasium",
    theme_active_var1_activity: "[KOREAN] swimming with mechanical dolphins",
    theme_active_var2_scene: "[KOREAN] desert canyon adventure",
    theme_active_var2_activity: "[KOREAN] rock climbing up a vertical mesa",

    theme_break_title: "[KOREAN] Take a well-earned break",
    theme_break_var0_scene: "[KOREAN] luxury cloud resort",
    theme_break_var0_activity: "[KOREAN] lounging in a golden hammock",
    theme_break_var1_scene: "[KOREAN] secluded x hot spring cave",
    theme_break_var1_activity: "[KOREAN] soaking in steaming mineral waters",
    theme_break_var2_scene: "[KOREAN] vintage jazz lounge on Mars",
    theme_break_var2_activity: "[KOREAN] sipping a cosmic mocktail",

    theme_skill_title: "[KOREAN] Learn a new skill",
    theme_skill_var0_scene: "[KOREAN] master glassblower workshop",
    theme_skill_var0_activity: "[KOREAN] shaping a molten glass phoenix",
    theme_skill_var1_scene: "[KOREAN] grand symphony hall",
    theme_skill_var1_activity: "[KOREAN] conducting an orchestra of musicians",
    theme_skill_var2_scene: "[KOREAN] digital neon arcade",
    theme_skill_var2_activity: "[KOREAN] winning a pro-gaming championship",

    theme_creative_title: "[KOREAN] Get more creative",
    theme_creative_var0_scene: "[KOREAN] rooftop garden studio",
    theme_creative_var0_activity: "[KOREAN] sculpting a giant floral statue",
    theme_creative_var1_scene: "[KOREAN] street art alleyway",
    theme_creative_var1_activity: "[KOREAN] spray painting a vibrant mural",
    theme_creative_var2_scene: "[KOREAN] grand symphony hall",
    theme_creative_var2_activity: "[KOREAN] conducting an orchestra of lights",

    theme_imagination_title: "[KOREAN] Let my imagination run loose",
    theme_imagination_var0_scene: "[KOREAN] steampunk airship bridge",
    theme_imagination_var0_activity: "[KOREAN] navigating through a thundercloud",
    theme_imagination_var1_scene: "[KOREAN] giant mushroom kingdom",
    theme_imagination_var1_activity: "[KOREAN] talking to a curious dragon",
    theme_imagination_var2_scene: "[KOREAN] floating clockwork city",
    theme_imagination_var2_activity: "[KOREAN] rewinding the gears of time",

    theme_green_title: "[KOREAN] Master the Green",
    theme_green_var0_scene: "[KOREAN] lush, sun-drenched championship golf course",
    theme_green_var0_activity: "[KOREAN] sinking a perfect tournament-winning putt",
    theme_green_var1_scene: "[KOREAN] exclusive private grass tennis court at golden hour",
    theme_green_var1_activity: "[KOREAN] executing a flawless jumping backhand smash",
    theme_green_var2_scene: "[KOREAN] dramatic cliffside golf hole overlooking a crashing ocean",
    theme_green_var2_activity: "[KOREAN] teeing off into a spectacular sunset",

    theme_culinary_title: "[KOREAN] Indulge my inner foodie",
    theme_culinary_var0_scene: "[KOREAN] exclusive Chef's table in a Michelin-star kitchen",
    theme_culinary_var0_activity: "[KOREAN] tasting a masterpiece of molecular gastronomy",
    theme_culinary_var1_scene: "[KOREAN] sunlit luxury terrace overlooking the Amalfi coast",
    theme_culinary_var1_activity: "[KOREAN] enjoying a perfectly plated truffle risotto",
    theme_culinary_var2_scene: "[KOREAN] misty, ancient forest in the Piedmont region",
    theme_culinary_var2_activity: "[KOREAN] foraging for rare white truffles with a master guide",

    theme_warrior_title: "[KOREAN] Unleash the weekend warrior",
    theme_warrior_var0_scene: "[KOREAN] rugged, pine-covered mountain bike trail",
    theme_warrior_var0_activity: "[KOREAN] catching air over a massive dirt jump",
    theme_warrior_var1_scene: "[KOREAN] remote, untouched backcountry mountain peak",
    theme_warrior_var1_activity: "[KOREAN] carving fresh powder tracks on a snowboard",
    theme_warrior_var2_scene: "[KOREAN] roaring, crystal-clear white-water canyon river",
    theme_warrior_var2_activity: "[KOREAN] expertly navigating a sleek carbon-fiber kayak",

    theme_racing_title: "[KOREAN] Chase the Grand Prix thrill",
    theme_racing_var0_scene: "[KOREAN] sweeping corner of a sunlit private race circuit",
    theme_racing_var0_activity: "[KOREAN] steering a roaring vintage Ferrari",
    theme_racing_var1_scene: "[KOREAN] glamorous Monaco street circuit at dusk",
    theme_racing_var1_activity: "[KOREAN] celebrating a first-place podium finish",
    theme_racing_var2_scene: "[KOREAN] pristine, high-tech luxury racing garage",
    theme_racing_var2_activity: "[KOREAN] analyzing telemetry data next to a Le Mans hypercar",

    theme_alpine_title: "[KOREAN] Conquer the Alpine peaks",
    theme_alpine_var0_scene: "[KOREAN] dramatic, snow-capped Swiss summit",
    theme_alpine_var0_activity: "[KOREAN] standing victorious with an ice axe in hand",
    theme_alpine_var1_scene: "[KOREAN] sheer, vertical granite rock face above the clouds",
    theme_alpine_var1_activity: "[KOREAN] free-climbing with intense focus and grip",
    theme_alpine_var2_scene: "[KOREAN] remote, untouched glacier in British Columbia",
    theme_alpine_var2_activity: "[KOREAN] carving the first tracks after a thrilling heli-drop",

    // --- Kiosk Flow: Loading ---
    loading_message_0: "[KOREAN] Initializing Gemini Nano Banana 2 model...",
    loading_message_1: "[KOREAN] Analyzing facial structure and lighting...",
    loading_message_2: "[KOREAN] Applying selected theme and style...",
    loading_message_3: "[KOREAN] Generating high-resolution details...",
    loading_message_4: "[KOREAN] Adding final polish and cinematic effects...",

    // --- Kiosk Flow: Results & Refine ---
    result_title: "[KOREAN] Ta-da!",
    result_subtitle: "[KOREAN] Scan the code to download your masterpiece.",
    btn_adjust_style: "[KOREAN] Adjust style",
    btn_make_video: "[KOREAN] Make it a Video",
    btn_generating_video: "[KOREAN] Generating Video...",
    btn_retry_video: "[KOREAN] Retry Video",
    btn_done: "[KOREAN] I'm done!",
    ...
    // --- Kiosk Flow: Thanks ---
    thanks_title: "[KOREAN] Enjoy your free time!",
    thanks_start_over: "[KOREAN] Start over"
  }
};
